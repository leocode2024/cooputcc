...
<head>
    ...
    <title>
      Dashboard พี่เลี้ยงสหกิจ - โครงการสหกิจศึกษา มหาวิทยาลัยหอการค้าไทย
    </title>
    ...
    />
    <link rel="stylesheet" href="/cooputcc/asset/css/dashboard/mentor_dashboard.css" />
</head>
<body>
    <!-- Header -->
    <header class="header d-flex align-items-center justify-content-between">
      <div class="d-flex align-items-center">
        ...
        <div class="titles">
          ...
          <h5 style="color: #ffd600">> ยินดีต้อนรับ [ชื่อพี่เลี้ยง]</h5>
        </div>
      </div>
      <div class="d-flex align-items-center">
    ...
    <div class="content">
      <div class="dashboard-header">
        <div class="students">
          ...
          <div class="text">นักศึกษาที่ดูแล<br />[1 คน]</div>
        </div>
      </div>
      <!-- ข้อมูลนักศึกษาในความดูแล -->
      <div class="highlight">ข้อมูลนักศึกษาในความดูแล</div>
      <h3></h3>
