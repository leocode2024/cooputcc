...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/cooputcc/asset/css/dashboard/student_dashboard_waiting_approve.css" />
  ...
  <body>
    ...
    <div class="content">
      <div class="welcome-text">
        ...
        <p style="color: black">
          ทางโครงการสหกิจศึกษา มหาวิทยาลัยหอการค้าไทย<br />
          ได้รับข้อมูลการลงทะเบียนสหกิจศึกษาของท่านเรียบร้อยแล้ว โปรดรอเจ้าหน้าที่ติดต่อกลับอีกครั้ง
          <br />
        </p>
        <h1></h1>
        <p style="color: black">
