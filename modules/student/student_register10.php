...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/cooputcc/asset/css/register/student_register_uploadphoto.css" />
  ...
  <body>
    ...
    <div class="sidebar">
      ...
      >
      <a href="" class="active"><i class="fas fa-image"></i> รูปถ่ายนักศึกษา</a>
    ...
    <div class="content">
      <div class="container">
        <div class="row justify-content-left">
          <div class="col-12">
            <h4 class="mb-5 bold-text">รูปถ่ายนักศึกษา</h4>
          </div>
          <!-- Main content area -->
            ...
            <div class="registration-form">
              ...
              <form action="">
                ...
                <div class="mb-4 text-center">
                  ...
                  <div class="form-group">
                    <div id="image_container">
                      <i id="image_icon" class="fas fa-user"></i>
                      <img
                        id="image_preview"
                        src="#"
                        alt="รูปภาพที่เลือก"
                    ...
                    <label for="student_photo" class="form-label mt-2"
                      >เลือกรูปภาพ:</label
                    >
                    <input
                      type="file"
                    ...
                    <small style="color: red">
                      <br />*** เป็นรูปถ่ายหน้าตรงเท่านั้น
                    </small>
                    <small style="color: red">
                      <br />*** ขนาดรูปภาพที่เหมาะสม กว้างไม่เกิน 71x92 pixels
                    </small>
                    <small style="color: red">
                      <br />*** ประเภทของรูปภาพที่รองรับ .jpg, .jpeg, .png และ
                      .gif เท่านั้น
                    </small>
                  </div>
                </div>
                ...
                <div class="form-group text-center mt-4">
                  ...
                  <a
                    href="/cooputcc/modules/student/student_register11.php"
    ...
    <script src="/cooputcc/asset/js/preview_image.js"></script>
  </body>
</html>
