...
<head>
    ...
    <title>เข้าสู่ระบบของพี่เลี้ยงสหกิจ - โครงการสหกิจศึกษา มหาวิทยาลัยหอการค้าไทย</title>
    ...
    <link rel="stylesheet" href="/cooputcc/asset/css/login/mentor_login.css"/>
</head>
<body>
    <!-- Header -->
    <header class="header d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center">
            ...
            <div class="titles">
                ...
                <h5 style="color: #FFD600;">> เข้าสู่ระบบของพี่เลี้ยงสหกิจ</h5>
            </div>
        </div>
    ...
    <div class="content">
        <div class="container">
            <div class="row justify-content-center">
                <h3 class="mb-4 bold-text" style="color: #d9534f; text-align: center;">
                    <i class="fas fa-user-tie icon"></i> เข้าสู่ระบบของพี่เลี้ยงสหกิจ
                </h3>
                <div class="col-md-8 col-lg-6">
                    <div class="login-form">
                        <form>
                            <div class="form-group">
                                <label for="mentor_id" class="form-label">ชื่อผู้ใช้งาน:</label>
                                <input type="text" class="form-control" id="mentor_id" placeholder="ชื่อผู้ใช้งาน">
                            </div>
                            <div class="form-group">
                                <label for="mentor_password" class="form-label">รหัสผ่าน:</label>
                                <input type="password" class="form-control" id="mentor_password" placeholder="รหัสผ่าน">
                            </div>
                            <div class="button-group">
                                <a href="/cooputcc/modules/mentor/mentor_dashboard.php" class="btn btn-custom btn-login">
